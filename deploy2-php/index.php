...
<head>
    ...
    <!-- Changed from Flask url_for to direct paths -->
...
<body>
    <div class="container">
        ...
        <div class="privacy-policy" id="privacyPolicy">
            ...
            <p>Please read the following and check all boxes to proceed:</p>
            <ul>
                <li><label><input type="checkbox" class="privacy-checkbox"> <span>I have read and understood the
                            information
                            regarding my participation in this online research study</span></label></li>
                <li><label><input type="checkbox" class="privacy-checkbox"> <span>I agree to the conditions and consent
                            to
                            participate in the study</span></label></li>
                <li><label><input type="checkbox" class="privacy-checkbox"> <span>I give my consent for the anonymous
                            data
                            collected to be used for research purposes and made accessible to other researchers</label>
                </li>
                <li><label><input type="checkbox" class="privacy-checkbox"> <span>I understand I can terminate my
                            participation at any time, and my data will be erased upon request</span></label></li>
                <li><label><input type="checkbox" class="privacy-checkbox"> <span>I understand that ELTE FoI Department
                            of
                            Artificial Intelligence will handle my personal data confidentially and will not allow
                            access to
                            unauthorized parties</span></label></li>
                <li><label><input type="checkbox" class="privacy-checkbox"> <span>I have read and agree to the Privacy
                            Notice</span></label></li>
                <li><label><input type="checkbox" id="check-all" class="privacy-checkbox"> <span>
                            I agree to all the terms and conditions outlined above
                        </span></label></li>
            </ul>
            ...
            <form id="questionnaireForm" novalidate>
                ...
                <div class="section">
                    ...
                    <div class="form-group" id="education-group">
                        ...
                        <div class="error-message">Please select your highest education level.</div>
                    </div>
                ...
                <div class="section" id="emotionRatingsSection" style="display: none;">
                    ...
                    <p class="info-text">Listen to each sound and rate the emotions you feel. You can select 1 or 2
                        emotions per sound.</p>
                ...
                <button type="submit" class="submit-btn" id="submitBtn" style="display: none;">Submit
    ...
    <div class="modal-success" id="modalSuccess">
        ...
        <div class="modal-info" id="modalInfo" style="font-size:.97em;color:#333;margin-bottom:8px;">
            Make sure to save this code — you'll need it if you want your data deleted.
        </div>
        <button id="fillAgainBtn" type="button">Fill Another Questionnaire</button>
    </div>

    <script>
        // Enable the "I Agree" button only after all checkboxes are checked
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', () => {
                ...
                checkAll.checked = allChecked; // Sync "Check All" state
                updateAgreeButtonState();
            });
        });
        ...
        function createRatingItem(index, soundPath) {
            ...
            newRating.innerHTML = `
                ...
                <div class="form-group" id="emotion1-group-${index}">
                    ...
                    <div class="error-message">Please select a primary emotion.</div>
                </div>
                ...
                <div class="form-group" id="emotion2-group-${index}">
                    ...
                    <div class="error-message">Please select a secondary emotion if you provided a rating.</div>
                </div>
        ...
        function showSuccessModal(message, code) {
            ...
            document.getElementById('modalCode').innerHTML = code
                ? '<strong>Your submission code: ' + code + '</strong>'
                : '';
